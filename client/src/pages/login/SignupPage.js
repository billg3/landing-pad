...
class Login extends React.Component {
    ...
    render(){
        ...
        const imgStyle = {width:'400px', marginLeft:'auto', marginRight:'auto', marginTop:'70px', boxShadow:'none'}
        ...
        const tStyle = {boxShadow:'none'}
        const blue = {color:'#3D3D9D',fontWeight:'bold'}
            ...
            <div className="container" id="full-body">
                ...
                <img src='https://i.imgur.com/HKH2zed.gif' style={imgStyle} />
                    ...
                    <div className=" fixed-bottom" id="sign-in">
                       <Link to="/"><button  color="primary" style={bottomButton} onClick={this.showModal.bind(this, "modal1")}>SIGN IN</button></Link>
                    </div>
                    <div className=" fixed-bottom" id="sign-up">
                        <button color="primary" style={bottomButtonOrange} onClick={this.showModal.bind(this, "modal2")}>SIGN UP</button>
                        <Modal isOpen={this.state.modal2} toggle={this.closeModal.bind(this, "modal2")} className={this.props.className} id="enter-modal">
                            <ModalHeader toggle={this.closeModal.bind(this, "modal2")} className="mod-title" style={blue}>SIGN UP</ModalHeader>
