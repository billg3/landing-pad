...
class NewSpot extends React.Component {
    ...
    compileTime = () => {
        ...
        for(let d = tempStart; d <= tempEnd; new Date(d.setDate(d.getDate() + 1))){
            ...
            for(var i = 1; i <= 24; i++){
                const key = i 
                const timeObj = { time:i, available:'false', classn:'false', renterId:'' }
                console.log()
                    ...
                    <div className="col-xs-12 justify-content-center" id="form-div">
                        <div className ="text-center" id="spacer">
                            <Container className="py-4">
                                ...
                                <div id="submit-div">
                                    <button id='submit-button' style={submitButton} onClick={() => this.compileTime()}>Submit</button>
                                </div>
                            </Container>  
                        </div>
                    </div>
